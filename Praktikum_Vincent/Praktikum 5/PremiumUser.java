...
public class PremiumUser extends User {
  ...
  public void print(){
		if(songList.size()!=0){
			System.out.println(super.getName()+": Premium User. Last song: "+ songList.get(songList.size()-1)+"."); 
		}
		else{
			System.out.println(super.getName()+": Premium User. Last song: .");
		}
	}
  ...
  public void listen(String song){
	  System.out.println(super.getName()+" now listening to "+song+".");
	  songList.add(song);
	}
  ...
  public void download(String song){
	  System.out.println(super.getName()+" download "+song+".");
	  songList.add(song);
	}
